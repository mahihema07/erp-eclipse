System.register(["@angular/core", "@angular/http", "rxjs/Rx", "rxjs/add/operator/map", "rxjs/add/operator/catch"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Rx_1, AccountGroupService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            AccountGroupService = /** @class */ (function () {
                function AccountGroupService(http) {
                    this.http = http;
                ...
                AccountGroupService.prototype.loadAllModelData = function () {
                    return this.http
                        .post(this.loadDataAllUrl, {})
                        .map(function (res) { return res.json(); })
                        .catch(function (error) { return Rx_1.Observable.throw(error.json().error || 'Server error'); });
                };
                AccountGroupService.prototype.loadModelDataById = function (id) {
                    return this.http
                        .post(this.loadDataByIdUrl, id)
                        .map(function (res) { return res.json(); })
                        .catch(function (error) { return Rx_1.Observable.throw(error.json().error || 'Server error'); });
                };
                AccountGroupService.prototype.loadModelDataByPage = function (params) {
                    return this.http
                        .post(this.loadDataByPageUrl, params)
                        .map(function (res) { return res.json(); })
                        .catch(function (error) { return Rx_1.Observable.throw(error.json().error || 'Server error'); });
                };
                AccountGroupService.prototype.submitModel = function (params) {
                    return this.http
                        .post(this.submitFormUrl, params)
                        .map(function (res) { return res.json(); })
                        .catch(function (error) { return Rx_1.Observable.throw(error.json().error || 'Server error'); });
                };
                AccountGroupService.prototype.deleteModel = function (id) {
                    return this.http
            ...
            exports_1("AccountGroupService", AccountGroupService);
        }
    };
});
//# sourceMappingURL=app.groups.service.js.map