System.register(["@angular/core", "@angular/http", "@angular/router", "rxjs/add/operator/map", "../../common/services/app.constants", "./services/app.suppliers.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, router_1, app_constants_1, app_suppliers_service_1, SuppliersList;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            SuppliersList = /** @class */ (function () {
                function SuppliersList(http, route, router, formService) {
                    this.http = http;
                    this.route = route;
                    this.router = router;
                ...
                SuppliersList.prototype.ngOnInit = function () {
                    this.loadDataByPage(this.initialPageNo);
                };
                SuppliersList.prototype.onPageChange = function (page) {
                    //this.rowsOnPage = event.rowsOnPage;
                    this.activePage = page;
                    this.loadDataByPage(page);
                };
                SuppliersList.prototype.createNew = function () {
                    this.router.navigate(['home/suppliers/crud', 0]);
                };
                SuppliersList.prototype.filterQueryChange = function (event) {
                    this.loadDataByPage(this.initialPageNo);
                };
                SuppliersList.prototype.loadDataByPage = function (page) {
                    var _this = this;
                    var params = {
                        pageNumber: page,
                ...
                SuppliersList.prototype.deleteModel = function (id) {
                    var _this = this;
