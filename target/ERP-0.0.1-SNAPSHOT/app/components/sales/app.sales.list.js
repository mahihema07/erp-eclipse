System.register(["@angular/core", "@angular/http", "@angular/router", "rxjs/add/operator/map", "../../common/services/app.constants", "./services/app.sales.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, router_1, app_constants_1, app_sales_service_1, SalesList;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            SalesList = /** @class */ (function () {
                function SalesList(http, route, router, formService) {
                    this.http = http;
                    this.route = route;
                    this.router = router;
                ...
                SalesList.prototype.ngOnInit = function () {
                    this.loadDataByPage(this.initialPageNo);
                };
                SalesList.prototype.onPageChange = function (page) {
                    this.activePage = page;
                    this.loadDataByPage(page);
                };
                SalesList.prototype.createNew = function () {
                    this.router.navigate(['home/sales/crud', 0]);
                };
                SalesList.prototype.filterQueryChange = function (event) {
                    this.loadDataByPage(this.initialPageNo);
                };
                SalesList.prototype.loadDataByPage = function (page) {
                    var _this = this;
                    var params = {
                        pageNumber: page,
                ...
                SalesList.prototype.deleteModel = function (id) {
                    var _this = this;
