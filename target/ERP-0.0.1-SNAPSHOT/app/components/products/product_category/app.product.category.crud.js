System.register(["@angular/core", "@angular/http", "@angular/router", "rxjs/add/operator/map", "../../../common/services/app.constants", "./services/app.category.service"], function (exports_1, context_1) {
    ...
    var core_1, http_1, router_1, app_constants_1, app_category_service_1, CategoryCrud;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            CategoryCrud = /** @class */ (function () {
                function CategoryCrud(http, route, router, formService) {
                    this.http = http;
                    this.route = route;
                    this.router = router;
                    this.formService = formService;
                    this.listRoute = 'home/category/list';
                }
                ...
                CategoryCrud.prototype.submitForm = function (data) {
                    var _this = this;
                    try {
                ...
                CategoryCrud.prototype.backToHome = function () {
                    this.router.navigate([this.listRoute]);
                };
                CategoryCrud.prototype.loadFormData = function (id) {
                    var _this = this;
                ...
                CategoryCrud.prototype.deleteModel = function (id) {
                    var _this = this;
                ...
                CategoryCrud.prototype.isValidForm = function () {
                    return true;
                };
                CategoryCrud = __decorate([
                    core_1.Component({
            ...
            exports_1("CategoryCrud", CategoryCrud);
        }
    };
});
//# sourceMappingURL=app.product.category.crud.js.map