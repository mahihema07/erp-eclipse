System.register(["@angular/core", "@angular/http", "@angular/router", "rxjs/add/operator/map", "../../../common/services/app.constants"], function (exports_1, context_1) {
    ...
    var core_1, http_1, router_1, app_constants_1, ProductSpecificationList;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ProductSpecificationList = /** @class */ (function () {
                function ProductSpecificationList(http, route, router) {
                    this.http = http;
                    this.route = route;
                    this.router = router;
                    this.crudRoute = 'home/productspecification/crud';
                    this.filterQuery = "";
                    this.rowsOnPage = 10;
                    this.activePage = 1;
                    this.itemsTotal = 0;
                ...
                ProductSpecificationList.prototype.ngOnInit = function () {
                    this.loadDataByPage(this.initialPageNo);
                };
                ProductSpecificationList.prototype.backToHome = function () {
                    this.router.navigate(['/home']);
                };
                ProductSpecificationList.prototype.loadDataByPage = function (page) {
                    var _this = this;
                ...
                ProductSpecificationList.prototype.onPageChange = function (page) {
                    this.activePage = page;
                    this.loadDataByPage(page);
                };
                ProductSpecificationList.prototype.filterQueryChange = function (event) {
                    this.loadDataByPage(this.initialPageNo);
                };
                ProductSpecificationList.prototype.createNew = function () {
                    this.router.navigate([this.crudRoute, 0]);
                };
                ProductSpecificationList.prototype.deleteModel = function (id) {
                    var _this = this;
                    this.http
                ...
                ProductSpecificationList = __decorate([
                    core_1.Component({
            ...
            exports_1("ProductSpecificationList", ProductSpecificationList);
        }
    };
});
//# sourceMappingURL=app.productspecification.list.js.map