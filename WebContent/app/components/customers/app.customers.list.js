System.register(["@angular/core", "@angular/http", "@angular/router", "rxjs/add/operator/map", "../../common/services/app.constants", "./services/app.customers.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, router_1, app_constants_1, app_customers_service_1, CustomersList;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            CustomersList = /** @class */ (function () {
                function CustomersList(http, route, router, formService) {
                    this.http = http;
                    this.route = route;
                    this.router = router;
                ...
                CustomersList.prototype.ngOnInit = function () {
                    this.loadDataByPage(this.initialPageNo);
                };
                CustomersList.prototype.onPageChange = function (page) {
                    //this.rowsOnPage = event.rowsOnPage;
                    this.activePage = page;
                    this.loadDataByPage(page);
                };
                CustomersList.prototype.createNew = function () {
                    this.router.navigate(['home/customers/crud', 0]);
                };
                CustomersList.prototype.filterQueryChange = function (event) {
                    this.loadDataByPage(this.initialPageNo);
                };
                CustomersList.prototype.loadDataByPage = function (page) {
                    var _this = this;
                    var params = {
                        pageNumber: page,
                ...
                CustomersList.prototype.deleteModel = function (id) {
                    var _this = this;
