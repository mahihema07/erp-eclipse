System.register(["@angular/core", "@angular/http", "@angular/router", "rxjs/add/operator/map", "../../common/services/app.constants", "./services/app.stockadjust.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, router_1, app_constants_1, app_stockadjust_service_1, StockAdjustList;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            StockAdjustList = /** @class */ (function () {
                function StockAdjustList(http, route, router, formService) {
                    this.http = http;
                    this.route = route;
                    this.router = router;
                ...
                StockAdjustList.prototype.ngOnInit = function () {
                    this.loadDataByPage(this.initialPageNo);
                };
                StockAdjustList.prototype.onPageChange = function (page) {
                    this.activePage = page;
                    this.loadDataByPage(page);
                };
                StockAdjustList.prototype.createNew = function () {
                    this.router.navigate(['home/stockadjust/crud', 0]);
                };
                StockAdjustList.prototype.filterQueryChange = function (event) {
                    this.loadDataByPage(this.initialPageNo);
                };
                StockAdjustList.prototype.loadDataByPage = function (page) {
                    var _this = this;
                    var params = {
                        pageNumber: page,
                ...
                StockAdjustList.prototype.deleteModel = function (id) {
                    var _this = this;
