...
@Component( {
    ...
    providers: [CurrencyCoversionService]
} )

export class CurrencyConversionList implements OnInit {
  
    private crudRoute: string = 'home/currencyconversion/crud';
    ...
    constructor( private http: Http, private route: ActivatedRoute, private router: Router,
        private formService: CurrencyCoversionService ) {
